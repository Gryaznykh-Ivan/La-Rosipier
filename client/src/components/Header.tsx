...
export default function Header() {
    ...
    return (
        <div className="fixed w-full">
            ...
            <div className={`absolute w-full h-screen ${isBurgerOpened ? "bg-black" : "none"} bg-opacity-30 transform transition-colors duration-300 md:hidden z-10`} onClick={onBurgerClose}>
